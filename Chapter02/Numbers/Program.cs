...
double anotherRealName = 2.3;//double literal

Console.WriteLine(naturalNumber);
Console.WriteLine(integerNumber);
Console.WriteLine(realNumber);
Console.WriteLine(anotherRealName);
...
Console.WriteLine($"int uses{sizeof(int)} bytes"+
    $"and can store number in the range {int.MinValue:N0}{int.MaxValue:N0}");
Console.WriteLine($"int uses{sizeof(double)} bytes" +
    $"and can store number in the range {double.MinValue:N0}{double.MaxValue:N0}");
Console.WriteLine($"int uses{sizeof(decimal)} bytes" +
    $"and can store number in the range {decimal.MinValue:N0}{decimal.MaxValue:N0}");
