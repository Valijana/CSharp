...
//let the height in metres variable become equal to the value 1.88
...
//For text, multiple letters, such as Bob, are stored as a string type and are assigned
//using double quotes around the literal value

string firstName = "Bob";
string lastName = "Smith";
string phoneNumber = "(251) 555-4256";
...
//string filePath = "C:\televisions\sony\bravia.txt";-error
